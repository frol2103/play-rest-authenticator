package be.frol.playrestauthenticator.module
...
import be.frol.playrestauthenticator.daos._
import be.frol.playrestauthenticator.models.User
import be.frol.playrestauthenticator.providers.{LdapInfo, LdapProvider}
